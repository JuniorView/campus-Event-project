...
```
cd existing_repo
git remote add origin https://code.fbi.h-da.de/junior.dongmonguemo/campus-event-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.fbi.h-da.de/junior.dongmonguemo/campus-event-project/-/settings/integrations)
